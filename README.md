...
<!-- <p align="left"> <a href="https://github.com/ryo-ma/github-profile-trophy"><img src="https://github-profile-trophy.vercel.app/?username=turjo998" alt="turjo998" /></a> </p>
 -->
- 🔭 I’m currently working on **ERP development , Jasper Report , deploying project**

- 🌱 I’m currently learning **Devops Concept , Spring Framework**

- 📄 Know about my experiences [Here](https://drive.google.com/file/d/13zA_7UI2DfoG_mcUGCiBnm44iWe_8AAu/view?usp=drive_link)

> 💡 ***Feel free to reach out to me on [***linkedin***](https://www.linkedin.com/in/ullash-bhattacharjee-2637a51b1/) or [***mail***](mailto:97.bhattacharjee.ullash@gmail.com) if you have similar interests and want to discuss opportunities or collaborate.***
...
![PHP](https://img.shields.io/static/v1?&message=PHP&color=777BB4&logo=php&logoColor=white&label=)


### Backend
![Spring Boot](https://img.shields.io/static/v1?&message=Spring%20Boot&color=6DB33F&logo=spring&logoColor=white&label=)
![Grails](https://img.shields.io/static/v1?&message=Grails&color=6DAF8E&logo=grails&logoColor=white&label=)
...
<!--
## 🌟 Projects
-  Trainee Selection System (BJIT Academy Final Project): Trainee Selection System is an automated software solution that simplifies and streamlines the process of selecting trainees for job positions. It offers efficient applicant registration, comprehensive evaluation, and smooth communication among stakeholders. Technologies used:  Spring, React, Bootstrap, MySQL.
- Book Application (BJIT Academy Mid Project): This restful project consists of six microservices, including API Gateway, Discovery Server, Cloud Config Server, Authentication Service, Book Service, and Book Inventory Service. It ensures secure communication, efficient service discovery, and centralized configuration management for a seamless online book-shopping experience Technologies used: Spring-Boot, Spring Security, Micro-Service.
- Payroll Management System (Distributed Database Project): A Payroll Management project, that finds out the employees all kinds of information related to payroll from   the server site, and the employee himself/herself can access the VM Ware site to find out him/her all personal details. Technologies used: Oracle PL/SQL.
...
- e-BookCart (Web Development Project - 1): An e-commerce-based website for selling and monitoring updated books. Technologies used: Php, MySQL, Html, Css, Bootstrap,   Xampp Server. 
...
## 💻 Work Experience
- BJIT Group, Trainee Software Engineer, April 2023 - July 2023 <br/>
  Full Stack Software Engineer (Java EE, Spring, React, Security(JWT), Microservice, Git-Github, Redmine)
